...
5. Откройте cmd (Win+R) и перейдите в папку с проэктом
...
6. Откройте ещё одну cmd (Win+R) и введите команду
    ```bach
...
7. Откройте ещё одну cmd (Win+R) и введите команду что бы перейти в папку с LU
    ```bash
